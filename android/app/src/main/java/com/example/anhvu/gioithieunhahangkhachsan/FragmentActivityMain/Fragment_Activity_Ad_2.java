...
public class Fragment_Activity_Ad_2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView=inflater.inflate(R.layout.fragment_activity_ad_2,container,false);
        AnhXa();
    ...
    private void AnhXa(){
        txtRight=rootView.findViewById(R.id.clickRIGHT2);
        txtLeft=rootView.findViewById(R.id.clickLEFT2);
    }
}
