...
public class Adapter_Menu_Tinnhan_Member extends BaseAdapter {
    Context context;
    ArrayList<Class_Table_Tinnhan> list;

    public Adapter_Menu_Tinnhan_Member(Context context, ArrayList<Class_Table_Tinnhan> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // Animation anim= AnimationUtils.loadAnimation(context.getApplicationContext(),R.anim.phongtomotxiu);
        if(convertView==null){
            ...
            convertView=inflater.inflate(R.layout.item_tinnhan_member,null);
            viewHolder.txtTinnhanmember=convertView.findViewById(R.id.txt_item_Tinnhan_Member);
            viewHolder.txtTinnhanAdmin=convertView.findViewById(R.id.txt_item_Tinnhan_Admin);
