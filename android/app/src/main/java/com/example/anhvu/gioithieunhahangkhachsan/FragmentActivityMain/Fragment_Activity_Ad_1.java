...
public class Fragment_Activity_Ad_1 extends Fragment {
    ...
    private void AnhXa(){
        txtRight=rootView.findViewById(R.id.clickRIGHT1);
        txtLeft=rootView.findViewById(R.id.clickLEFT1);
    }
