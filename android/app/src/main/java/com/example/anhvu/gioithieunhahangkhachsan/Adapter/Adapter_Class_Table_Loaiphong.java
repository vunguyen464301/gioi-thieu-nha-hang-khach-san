...
public class Adapter_Class_Table_Loaiphong extends BaseAdapter {
    Context context;
    ArrayList<Class_Table_Loaiphong> list;

    public Adapter_Class_Table_Loaiphong(Context context, ArrayList<Class_Table_Loaiphong> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView=inflater.inflate(R.layout.item_listview_fragment_1,null);

            viewHolder.hinhchung=convertView.findViewById(R.id.img_listview_fragment_1);
            viewHolder.Maloai=convertView.findViewById(R.id.txtMaloaiphong_fragment_1);
            viewHolder.tenloai=convertView.findViewById(R.id.txtTenphong_fragment_1);
            viewHolder.soluong=convertView.findViewById(R.id.txtSoluong_fragment_1);
            //phải settag converview lại ,không thì khi kéo lên kéo xuống sẽ bị bung lỗi
            convertView.setTag(viewHolder);
        }else
            viewHolder = (ViewHolder)convertView.getTag();
        Class_Table_Loaiphong cd=list.get(position);
        ...
        viewHolder.Maloai.setText(cd.getMaloaiphong()+"");
        viewHolder.tenloai.setText(cd.getTenphong()+"");
