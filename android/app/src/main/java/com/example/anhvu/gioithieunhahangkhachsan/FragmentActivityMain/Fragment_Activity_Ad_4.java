...
public class Fragment_Activity_Ad_4 extends Fragment {
    ...
    private void AnhXa(){
        txtRight=rootView.findViewById(R.id.clickRIGHT4);
        txtLeft=rootView.findViewById(R.id.clickLEFT4);
    }
}
