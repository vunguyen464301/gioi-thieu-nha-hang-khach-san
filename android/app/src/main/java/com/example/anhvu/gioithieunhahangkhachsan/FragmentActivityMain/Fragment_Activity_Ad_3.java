...
public class Fragment_Activity_Ad_3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView=inflater.inflate(R.layout.fragment_activity_ad_3,container,false);
        AnhXa();
    ...
    private void AnhXa(){
        txtRight=rootView.findViewById(R.id.clickRIGHT3);
        txtLeft=rootView.findViewById(R.id.clickLEFT3);
    }
}
